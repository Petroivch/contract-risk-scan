...
import type { PresetRoleId } from '../roles/presetRoles';
import {
  getPresetRoleLabel,
  getPresetRoleOptions,
  resolveConfiguredPresetRoleIds,
} from '../roles/presetRoles';
...
export const UploadWithRoleScreen = ({ navigation }: Props): JSX.Element => {
  ...
  const [selectedPresetRoleId, setSelectedPresetRoleId] = useState<PresetRoleId | null>(
    ...
    <ScreenShell title={t('upload.title')} subtitle={t('upload.subtitle')} scroll>
      ...
      <View style={styles.roleCard}>
        ...
        <EditableRoleDropdown
          ...
          onSelectPreset={(presetRoleId) => setSelectedPresetRoleId(presetRoleId as PresetRoleId)}
